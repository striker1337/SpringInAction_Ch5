...
public class SpittleControllerTest {
	...
	//Assert ressource oriented path access
	@Test
	...
	public void shouldShowPagedSpittles() throws Exception{
		...
		// BUILD UP THE MOCK AND INJECT INTO VIEW, TEST RESULTING VIEW
		...
		// Perform a Get with the needed parameters to extract additional data
